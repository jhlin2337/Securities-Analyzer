...
crawler1 = crawler_path + 'Crawler_17Q1.idx'
crawler2 = crawler_path + 'Crawler_17Q2.idx'
crawler3 = crawler_path + 'Crawler_17Q3.idx'
# crawler4 = crawler_path + 'Crawler_15Q4.idx'
report = reports_path + 'Annual_Reports_17_SIC.txt'
reportxml = reports_path + 'Annual_Reports_17_Ticker_XML_SIC.txt'
...
for line in annual_reports:
	...
	try:
		...
		# Find SIC code
		sic_regexp = r'<b><a href="/cgi-bin/browse-edgar.*?SIC.*?">.*?</a></b>'
		sic_code = re.findall(sic_regexp, index_page_text)
		sic_code = (re.findall(r'">.+?<', sic_code[0]))[0]
		sic_code = sic_code[2:len(sic_code)-1]
		print(sic_code)

		# Write data into file
		annual_reports_ticker_xml.write(sic_code + '     ')
